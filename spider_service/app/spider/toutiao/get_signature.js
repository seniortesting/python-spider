/**
 分析算法来自： http://notech.net/886.html
 https://blog.csdn.net/weixin_40444270/article/details/81269801
 https://github.com/xzh0723/Toutiao/blob/master/hotNews
 步骤：
 1. 切换到network，直接ctrl+f搜索_signature
 **/
navigator = {
...
/** 如果是0 代表的是refresh，否则是loadmore =max_behot_time_tmp  */
function get_signature(max_behot_time_tmp) {
    Function(function (t) {
    ...
    var i = TAC.sign(max_behot_time_tmp)
    return i
}
